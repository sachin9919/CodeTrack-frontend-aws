...
const Issues = () => {
    ...
    const fetchIssues = async () => {
        ...
        try {
            ...
            const response = await api.get(`/repo/${id}/issues`, {
                headers: authHeaders
            });
            // Axios response data is directly the data
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.post(`/repo/${id}/issues`, payload, {
                headers: postHeaders
            });

            // If successful, re-fetch issues
            fetchIssues();
            setNewIssue(""); // Clear the input box
            ...
            console.error("Issue creation error:", err);
            // Axios error structure
            setError(err.response?.data?.error || err.message || "Network error during issue submission.");
        }
    };
